...
{
    public function __construct(protected readonly ModelInterface $item, string $resource, array $actions = [])
    {
    ...
    {
        return new ItemAction($this->item, $action, $this->resource, $options);
    }
